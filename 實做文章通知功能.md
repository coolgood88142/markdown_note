...
我們可以透過WebSocket實作上述的功能，Laravel中的BroadCast支援Pusher和Redis這兩個服務
...
| 好處         | 可以平台傳過來的資訊，繪製成報表、查詢發送定位，但是需要付費 | 可以自行設定資料到自己的本機上 |
| 內存資料     | x                                                            | v                              |
...
- https://ithelp.ithome.com.tw/articles/10231475
  ...
  http://boywhy.blogspot.com/2016/01/pusher.html
